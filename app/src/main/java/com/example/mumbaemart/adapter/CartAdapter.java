...
public class CartAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        switch (viewType) {
            ...
            case CartItemModel.TOTAL_AMOUNT:
                ...
                return new CartItemViewHolder.CartTotalAmountViewHolder(cartTotalView);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        switch (cartItemModelList.get(position).getType()) {
            ...
            case CartItemModel.TOTAL_AMOUNT:
                ...
                ((CartItemViewHolder.CartTotalAmountViewHolder) viewHolder).setTotalAmount(totalItems, totalItemPrice, deliveryPrice, totalAmount, savedAmount);
                break;
            default:
                return;
        }
    ...
    static class CartItemViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView coupensApplied;
        ...
        private void setItemDetails(int resource, String title, int freeCoupensNo, String productPriceText, String cuttedPriceText, int offersAppliedNo) {
            ...
            if (offersAppliedNo > 0) {
                ...
                offersApplied.setText(offersApplied + " Offers  applied");
            } else {
        ...
        public static class CartTotalAmountViewHolder extends RecyclerView.ViewHolder {
            ...
            public CartTotalAmountViewHolder(View cartTotalView) {
                super(cartTotalView);
            ...
            public void setTotalAmount(String totalItemsText, String totalItemPriceText, String deliveryPriceText, String totalAmountText, String savedAmountText) {
