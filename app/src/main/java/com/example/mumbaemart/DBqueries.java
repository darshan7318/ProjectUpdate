...
public class DBqueries {
    ...
    public static List<ArrayList<HomePageModel>> lists = new ArrayList<ArrayList<com.example.mumbaemart.model.HomePageModel>>();
                ...
                if (task.isSuccessful()) {
                    for (long x = 0;x < (long)task.getResult().get("list_size");x++) {
                        ...
                        if (loadProductData) {
                            ...
                            final String productId = task.getResult().get("product_ID").toString();
    ...
    public static void wishlistModelList(WishlistModel wishlistModel) {
    }
}